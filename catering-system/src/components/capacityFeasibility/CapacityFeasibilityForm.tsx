...
import type { CapacityFeasibilityInput } from '@/services/capacityFeasibilityService';
...
interface Props {
  onSubmit: (planId: string, planName: string, input: CapacityFeasibilityInput) => Promise<void>;
  submitting: boolean;
}

export function CapacityFeasibilityForm({ onSubmit, submitting }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="targetServiceDateTime" className="text-sm font-medium">目標服務時間 *</label>
        <Input
