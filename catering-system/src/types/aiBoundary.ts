...
export type BlockedReason =
  ...
  | 'F009_PHASE5B_GATE_CONFIG_MISSING'
  | 'F009_PHASE5B_DEPLOYMENT_GATE_MISSING'
  | 'F009_PHASE5B_DEPLOYMENT_GATE_WRONG_PROJECT'
  | 'F009_PHASE5B_DEPLOYMENT_GATE_WRONG_ENVIRONMENT'
  | 'F009_PHASE5B_PRODUCTION_DISABLED'
  | 'F009_PHASE5B_UNKNOWN_ENVIRONMENT_DEFAULT_DENY'
  | 'F009_PHASE5B_KILL_SWITCH_ON'
  | 'F009_PHASE5B_KILL_SWITCH_MISSING'
  | 'F009_PHASE5B_KILL_SWITCH_STALE'
  | 'F009_PHASE5B_KILL_SWITCH_RESET_AUDIT_INCOMPLETE'
  | 'F009_PHASE5B_KILL_SWITCH_RESET_TWO_PERSON_REQUIRED'
  | 'F009_PHASE5B_EMERGENCY_DISABLE_ACTIVE'
  | 'F009_PHASE5B_TENANT_ALLOWLIST_MISSING'
  | 'F009_PHASE5B_TENANT_ALLOWLIST_FAILED'
  | 'F009_PHASE5B_TENANT_NOT_ALLOWLISTED'
  | 'F009_PHASE5B_OPERATOR_ALLOWLIST_MISSING'
  | 'F009_PHASE5B_OPERATOR_ALLOWLIST_FAILED'
  | 'F009_PHASE5B_OPERATOR_NOT_ALLOWLISTED'
  | 'F009_PHASE5B_OPERATOR_CONFIRMATION_MISSING'
  | 'F009_PHASE5B_OPERATOR_CONFIRMATION_MALFORMED'
  | 'F009_PHASE5B_CONFIRMATION_TENANT_MISMATCH'
  | 'F009_PHASE5B_CONFIRMATION_APPROVAL_MISMATCH'
  | 'F009_PHASE5B_CONFIRMATION_APPLY_TOKEN_MISMATCH'
  | 'F009_PHASE5B_CONFIRMATION_VERSION_MISMATCH'
  | 'F009_PHASE5B_CONFIRMATION_BEFORE_HASH_MISMATCH'
  | 'F009_PHASE5B_CONFIRMATION_AFTER_HASH_MISMATCH'
  | 'F009_PHASE5B_CONFIRMATION_DIFF_HASH_MISMATCH'
  | 'F009_PHASE5B_CONFIRMATION_OPERATOR_MISMATCH'
  | 'F009_PHASE5B_CONFIRMATION_TIMESTAMP_INVALID'
  | 'F009_PHASE5B_DRYRUN_TENANT_MISMATCH'
  | 'F009_PHASE5B_DRYRUN_APPROVAL_MISMATCH'
  | 'F009_PHASE5B_DRYRUN_RECOMMENDATION_MISMATCH'
  | 'F009_PHASE5B_DRYRUN_AUDIT_TRAIL_MISMATCH'
  | 'F009_PHASE5B_DRYRUN_VERSION_MISMATCH'
  | 'F009_PHASE5B_DRYRUN_BEFORE_HASH_MISMATCH'
  | 'F009_PHASE5B_DRYRUN_AFTER_HASH_MISMATCH'
  | 'F009_PHASE5B_DRYRUN_DIFF_HASH_MISMATCH'
  | 'F009_PHASE5B_DRYRUN_APPLY_TOKEN_MISMATCH'
  | 'F009_PHASE5B_DRYRUN_PAYLOAD_HASH_MISMATCH'
  | 'F009_PHASE5B_AI_CALLER_BLOCKED'
  | 'F009_PHASE5B_SERVICE_ACCOUNT_BYPASS_BLOCKED'
  | 'F009_PHASE5B_ADMIN_SDK_BYPASS_BLOCKED'
  // Feature 009 Phase 5C: Deployment Token / HMAC / KMS contract
  | 'F009_PHASE5C_DEPLOYMENT_TOKEN_MISSING'
  | 'F009_PHASE5C_DEPLOYMENT_TOKEN_STALE'
  | 'F009_PHASE5C_DEPLOYMENT_TOKEN_MALFORMED'
  | 'F009_PHASE5C_DEPLOYMENT_TOKEN_INVALID_HMAC'
  | 'F009_PHASE5C_DEPLOYMENT_TOKEN_KMS_MISMATCH'
  | 'F009_PHASE5C_DEPLOYMENT_TOKEN_WRONG_PROJECT'
  | 'F009_PHASE5C_DEPLOYMENT_TOKEN_WRONG_ENVIRONMENT'
  | 'F009_PHASE5C_DEPLOYMENT_TOKEN_LOCAL_BYPASS_BLOCKED'
  | 'F009_PHASE5C_DEPLOYMENT_TOKEN_CI_BYPASS_BLOCKED'
  | 'F009_PHASE5C_DEPLOYMENT_GATE_MISSING'
  | 'F009_PHASE5C_TOKEN_INJECTED_GATE_MISSING'
  | 'F009_PHASE5C_GATE_UPDATED_TOKEN_INVALID'
  | 'F009_PHASE5C_TOKEN_INJECTED_GATE_UPDATE_FAILED'
  | 'F009_PHASE5C_SECURITY_COORDINATOR_INCONSISTENT'
  | 'F009_PHASE5C_NETWORK_PARTIAL_FAILURE'
  | 'F009_PHASE5C_DEV_FALLBACK_PRODUCTION_PATH_BLOCKED'
  | 'F009_PHASE5C_DEPLOYMENT_GATE_AUDIT_INCOMPLETE'
  | 'F009_PHASE5C_UNKNOWN_ENVIRONMENT_DEFAULT_DENY'
  // Feature 009 Phase 5C: Kill Switch Reset Transaction Protection
  | 'F009_PHASE5C_RESET_TXN_MISSING_REQUESTED_BY'
  | 'F009_PHASE5C_RESET_TXN_MISSING_APPROVED_BY'
  | 'F009_PHASE5C_RESET_TXN_TWO_PERSON_REQUIRED'
  | 'F009_PHASE5C_RESET_TXN_MISSING_REASON'
  | 'F009_PHASE5C_RESET_TXN_MISSING_PREVIOUS_STATE'
  | 'F009_PHASE5C_RESET_TXN_MISSING_NEXT_STATE'
  | 'F009_PHASE5C_RESET_TXN_PREVIOUS_STATE_MISMATCH'
  | 'F009_PHASE5C_RESET_TXN_NEXT_STATE_MISMATCH'
  | 'F009_PHASE5C_RESET_TXN_MISSING_AUDIT_TRAIL_ID'
  | 'F009_PHASE5C_RESET_TXN_DUPLICATE_BLOCKED_BY_IDEMPOTENCY'
  | 'F009_PHASE5C_RESET_TXN_AUDIT_WRITE_FAILED'
  | 'F009_PHASE5C_RESET_TXN_STATE_WRITE_FAILED'
  | 'F009_PHASE5C_RESET_TXN_INCONSISTENT_STATE_BLOCKED'
  | 'F009_PHASE5C_RESET_TXN_READ_SET_INVALID'
  | 'F009_PHASE5C_RESET_TXN_WRITE_SET_INVALID'
  | 'F009_PHASE5C_RESET_TXN_AI_CALLER_BLOCKED'
  | 'F009_PHASE5C_RESET_TXN_AI_APPROVAL_BLOCKED'
  // Feature 009 Phase 5C: Observation Mode
  | 'F009_PHASE5C_OBSERVATION_MODE_MISSING_STATE'
  | 'F009_PHASE5C_OBSERVATION_MODE_MALFORMED_STATE'
  | 'F009_PHASE5C_OBSERVATION_MODE_EXPIRED'
  | 'F009_PHASE5C_OBSERVATION_MODE_DEFAULT_DENY'
  | 'F009_PHASE5C_OBSERVATION_MODE_CONCURRENCY_CONFLICT'
  | 'F009_PHASE5C_OBSERVATION_MODE_CANNOT_ENABLE_PRODUCTION_WRITE'
  | 'F009_PHASE5C_OBSERVATION_MODE_OVERRIDDEN_BY_EMERGENCY_DISABLE'
  // Feature 009 Phase 5C: Emergency Disable interplay
  | 'F009_PHASE5C_EMERGENCY_DISABLE_OVERRIDES_RESET'
  | 'F009_PHASE5C_EMERGENCY_DISABLE_OVERRIDES_OBSERVATION_MODE'
  | 'F009_PHASE5C_EMERGENCY_DISABLE_BLOCKS_FUTURE_APPLY'
  // Feature 009 Phase 5C: AI / boundary
  | 'F009_PHASE5C_AI_CONFIG_APPLY_FORBIDDEN'
  | 'F009_PHASE5C_AI_KILL_SWITCH_RESET_FORBIDDEN'
  | 'F009_PHASE5C_AI_RESET_APPROVAL_FORBIDDEN'
  | 'F009_PHASE5C_AI_GATE_MUTATION_FORBIDDEN'
  | 'F009_PHASE5C_SERVICE_ACCOUNT_BYPASS_BLOCKED'
  | 'F009_PHASE5C_ADMIN_SDK_BYPASS_BLOCKED'
  // Feature 009 Phase 5D: Deployment Gate Partial Failure / Orphaned Token Recovery
  | 'F009_PHASE5D_CI_INTERRUPTED_BEFORE_TOKEN_INJECTION'
  | 'F009_PHASE5D_CI_INTERRUPTED_AFTER_TOKEN_INJECTION'
  | 'F009_PHASE5D_CI_INTERRUPTED_AFTER_GATE_UPDATE'
  | 'F009_PHASE5D_ORPHANED_TOKEN_DETECTED'
  | 'F009_PHASE5D_SELF_INVALIDATE'
  | 'F009_PHASE5D_TOKEN_INJECTED_GATE_UPDATE_FAILED'
  | 'F009_PHASE5D_GATE_UPDATED_TOKEN_INVALID'
  | 'F009_PHASE5D_TOKEN_EXPIRED_MID_FLOW'
  | 'F009_PHASE5D_DEPLOYMENT_ABORTED'
  | 'F009_PHASE5D_RETRY_REQUIRES_FRESH_APPROVAL'
  | 'F009_PHASE5D_RETRY_WITHOUT_FRESH_APPROVAL_BLOCKED'
  | 'F009_PHASE5D_GATE_AUTO_INVALIDATE'
  | 'F009_PHASE5D_GATE_STALE'
  | 'F009_PHASE5D_PARTIAL_FAILURE_FAIL_CLOSED'
  | 'F009_PHASE5D_NO_PRODUCTION_WRITE_PATH'
  | 'F009_PHASE5D_MISSING_DEPLOYMENT_ID'
  | 'F009_PHASE5D_MISSING_OPERATOR_ID'
  | 'F009_PHASE5D_MISSING_AUDIT_TRAIL_ID'
  // Feature 009 Phase 5D: Observation Mode High-Concurrency
  ...
  | 'F009_PHASE5D_OBSERVATION_FLAG_STALE'
  | 'F009_PHASE5D_OBSERVATION_FLAG_MISSING'
  | 'F009_PHASE5D_OBSERVATION_FLAG_MALFORMED'
  | 'F009_PHASE5D_OBSERVATION_FLAG_EXPIRED'
  | 'F009_PHASE5D_OBSERVATION_MODE_CANNOT_OVERRIDE_EMERGENCY_DISABLE'
  | 'F009_PHASE5D_OBSERVATION_MODE_CANNOT_ENABLE_PRODUCTION_WRITE'
  | 'F009_PHASE5D_UNKNOWN_STATE_DEFAULT_DENY'
  // Feature 009 Phase 5D: Production readiness boundary / AI guard
  | 'F009_PHASE5D_AI_CONFIG_APPLY_FORBIDDEN'
  | 'F009_PHASE5D_AI_KILL_SWITCH_RESET_FORBIDDEN'
  | 'F009_PHASE5D_AI_RESET_APPROVAL_FORBIDDEN'
  | 'F009_PHASE5D_AI_GATE_MUTATION_FORBIDDEN'
  | 'F009_PHASE5D_SERVICE_ACCOUNT_BYPASS_BLOCKED'
  | 'F009_PHASE5D_ADMIN_SDK_BYPASS_BLOCKED'
  | 'F009_PHASE5D_BROAD_ROLLOUT_BLOCKED'
  | 'F009_PHASE5D_CANARY_ROLLOUT_BLOCKED'
  // Feature 009 Phase 5E: Limited Staging-only Canary / Dry-run
  | 'F009_PHASE5E_PRODUCTION_READINESS_ONLY'
  | 'F009_PHASE5E_FATAL_SAFETY_VIOLATION'
  | 'F009_PHASE5E_PRODUCTION_WRITE_ATTEMPT_BLOCKED'
  | 'F009_PHASE5E_PRODUCTION_CANARY_WRITE_BLOCKED'
  | 'F009_PHASE5E_BROAD_ROLLOUT_BLOCKED'
  | 'F009_PHASE5E_CANARY_WITHOUT_DRY_RUN_BLOCKED'
  | 'F009_PHASE5E_STAGING_ONLY_DRY_RUN_ALLOWED'
  | 'F009_PHASE5E_UNKNOWN_STATE_DEFAULT_DENY'
  | 'F009_PHASE5E_TOKEN_INJECTION_FAILED'
  | 'F009_PHASE5E_GATE_UPDATE_FAILED'
  | 'F009_PHASE5E_NETWORK_INTERRUPTED_AFTER_TOKEN_INJECTION'
  | 'F009_PHASE5E_NETWORK_INTERRUPTED_AFTER_GATE_UPDATE'
  | 'F009_PHASE5E_ORPHANED_TOKEN_DETECTED'
  | 'F009_PHASE5E_SELF_INVALIDATE'
  | 'F009_PHASE5E_DEPLOYMENT_ABORTED'
  | 'F009_PHASE5E_MANUAL_APPROVAL_REVALIDATION_REQUIRED'
  | 'F009_PHASE5E_NO_AUTO_RETRY'
  | 'F009_PHASE5E_CI_REVALIDATION_TOKEN_REQUIRED'
  | 'F009_PHASE5E_PARTIAL_FAILURE_FAIL_CLOSED'
  | 'F009_PHASE5E_HIGH_LOAD_THRESHOLD_EXCEEDED'
  | 'F009_PHASE5E_HALT'
  | 'F009_PHASE5E_HALT_RECOVERY_REQUIRES_VERSION_ALIGNMENT'
  | 'F009_PHASE5E_VERSION_ALIGNMENT_MISMATCH'
  | 'F009_PHASE5E_GATE_RESET_BLOCKED'
  | 'F009_PHASE5E_CONCURRENCY_VIOLATION'
  | 'F009_PHASE5E_CONCURRENCY_VIOLATION_ERR'
  | 'F009_PHASE5E_CONCURRENT_RESET_APPLY_CONFLICT'
  | 'F009_PHASE5E_CONCURRENT_EMERGENCY_DISABLE_CONFLICT'
  | 'F009_PHASE5E_CONCURRENT_EXPIRY_APPLY_RACE'
  | 'F009_PHASE5E_EMERGENCY_DISABLE_PRIORITY_HOOK'
  | 'F009_PHASE5E_OBSERVATION_MODE_CANNOT_ENABLE_PRODUCTION_WRITE'
  | 'F009_PHASE5E_AUDIT_DIFFERENCE_DETECTED'
  | 'F009_PHASE5E_TENANT_BLOCKED_ON_DIFFERENCE'
  | 'F009_PHASE5E_AUDIT_PAYLOAD_INCOMPLETE'
  | 'F009_PHASE5E_FEATURE_FLAG_DISABLED'
  | 'F009_PHASE5E_FEATURE_FLAG_MALFORMED'
  | 'F009_PHASE5E_FEATURE_FLAG_CANNOT_ENABLE_PRODUCTION_WRITE'
  | 'F009_PHASE5E_FEATURE_FLAG_CANNOT_ENABLE_CANARY_ROLLOUT'
  | 'F009_PHASE5E_AI_CANARY_APPLY_FORBIDDEN'
  | 'F009_PHASE5E_AI_KILL_SWITCH_RESET_FORBIDDEN'
  | 'F009_PHASE5E_AI_RESET_APPROVAL_FORBIDDEN'
  | 'F009_PHASE5E_AI_GATE_MUTATION_FORBIDDEN';
