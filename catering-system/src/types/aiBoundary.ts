...
export type BlockedReason =
  ...
  | 'F009_PHASE5F_PRODUCTION_READINESS_ONLY'
  | 'F009_PHASE5F_FATAL_SAFETY_VIOLATION'
  | 'F009_PHASE5F_PRODUCTION_WRITE_ATTEMPT_BLOCKED'
  | 'F009_PHASE5F_PRODUCTION_CANARY_WRITE_BLOCKED'
  | 'F009_PHASE5F_BROAD_ROLLOUT_BLOCKED'
  | 'F009_PHASE5F_PRODUCTION_MUTATION_BLOCKED'
  | 'F009_PHASE5F_UNKNOWN_STATE_DEFAULT_DENY'
  | 'F009_PHASE5F_PERFORMANCE_DEGRADATION_RISK'
  | 'F009_PHASE5F_P99_TARGET_EXCEEDED'
  | 'F009_PHASE5F_TRACING_SAMPLE_ONLY'
  | 'F009_PHASE5F_HIGH_LOAD_THRESHOLD_EXCEEDED'
  | 'F009_PHASE5F_HALT'
  | 'F009_PHASE5F_TOKEN_MALFORMED'
  | 'F009_PHASE5F_TOKEN_MISSING'
  | 'F009_PHASE5F_TOKEN_STALE'
  | 'F009_PHASE5F_FLAG_MALFORMED'
  | 'F009_PHASE5F_FLAG_MISSING'
  | 'F009_PHASE5F_FLAG_STALE'
  | 'F009_PHASE5F_VERSION_MISMATCH'
  | 'F009_PHASE5F_SCHEMA_VALIDATION_FAILED'
  | 'F009_PHASE5F_SOC_AUDIT_EMITTED'
  | 'F009_PHASE5F_TENANT_LOCK_AMBIGUOUS_DEFAULT_DENY'
  | 'F009_PHASE5F_TENANT_LOCK_BLOCKED'
  | 'F009_PHASE5F_TENANT_LOCK_NON_WRITE'
  | 'F009_PHASE5F_AUDIT_DIFFERENCE_DETECTED'
  | 'F009_PHASE5F_DRY_RUN_DIFFERENCE_BLOCK'
  | 'F009_PHASE5F_AUDIT_PAYLOAD_INCOMPLETE'
  | 'F009_PHASE5F_EMERGENCY_DISABLE_PRIORITY_HOOK'
  ...
  | 'F009_PHASE5F_ROLLOUT_KILL_CRITERIA_TRIGGERED'
  | 'F009_PHASE5F_AI_APPLY_FORBIDDEN'
  | 'F009_PHASE5F_AI_RESET_FORBIDDEN'
  | 'F009_PHASE5F_AI_APPROVE_RESET_FORBIDDEN'
  | 'F009_PHASE5F_AI_MODIFY_GATE_FORBIDDEN';
